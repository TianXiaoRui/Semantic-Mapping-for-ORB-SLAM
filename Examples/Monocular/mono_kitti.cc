...
int main(int argc, char **argv)
{
    ...
    for(int ni=0; ni<nImages; ni++)
    {
        ...
        imSeg = cv::imread(vstrSemanticImage[ni], CV_LOAD_IMAGE_UNCHANGED);//读取语义分割后的图片
...
//read vstrSemanticImage as the semantic images
        ...
        vector<double> &vTimestamps)
{
    ...
    string strSemantic=strPathToSequence+"/result/gray/";
